...
export function Form({ categories }: Props){
    ...
    return (
        <main className={styles.container}>
            <h1>Novo Produto</h1>
            <form className={styles.form} action={handleRegisterProducts}>
                <label className={styles.labelImage}>
                    <span>
                        <UploadCloud size={30} color='#fff'/>
                    </span>
                    <input type='file' accept='image/png, image/jpg' required onChange={handleFile} name='file'/>
                    {previewImage && (
                ...
                <textarea className={styles.input} placeholder='Digite a descrição do produto...' required name='description'></textarea>
